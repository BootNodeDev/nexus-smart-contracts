...
const WBTC_MIN = ethers.utils.parseUnits('1', WBTC_DECIMALS);
const WBTC_MAX = ethers.utils.parseUnits('100000000000', WBTC_DECIMALS);
const WBTC_SLIPPAGE = 10000; // 100%

const USDC_ADDRESS = '0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b';
const USDC_DECIMALS = 6;
const USDC_MIN = ethers.utils.parseUnits('1', USDC_DECIMALS);
const USDC_MAX = ethers.utils.parseUnits('100000000000', USDC_DECIMALS);
...
const main = async () => {
  ...
  await daiAggregator.setLatestAnswer(BigNumber.from('297326770601058'));
  ...
  await wbtcAggregator.setLatestAnswer(BigNumber.from('14122319520000000000'));
  ...
  await usdcAggregator.setLatestAnswer(BigNumber.from('294786742537902'));
  ...
  await ((await master.enrollGovernance(signerAddress)).wait());
  await ((await master.enrollGovernance('0x756Cb8ed9872a470ba6c06e6109D6501DfFa08B6')).wait());
